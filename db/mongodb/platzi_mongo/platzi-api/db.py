...
def actualizar_curso(curso):
    ...
    return str(db.cursos.update_one( \
        ...
        {'$set': {'nombre':curso['nombre'], 'descripcion': curso['descripcion'], 'clases': curso['clases']}} \
        ).modified_count)
...
# db.cursos.createIndex({nombre:"text"})   variable nombre es cambiada a un indice de tipo text
